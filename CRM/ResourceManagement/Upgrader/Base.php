 ...
 */
class CRM_ResourceManagement_Upgrader_Base {

  /**
   * @var CRM_ResourceManagement_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_ResourceManagement_Upgrader(
        'resource-management',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_ResourceManagement_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_ResourceManagement_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
