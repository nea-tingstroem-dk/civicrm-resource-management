 ...
 *
 * Generated from resource-management/xml/schema/CRM/ResourceManagement/ResoureCalendar.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:c695e2827fbfe5c48d0015a75fc1152c)
 */
use CRM_ResourceManagement_ExtensionUtil as E;

/**
 * Database access object for the ResoureCalendar entity.
 */
class CRM_ResourceManagement_DAO_ResoureCalendar extends CRM_Core_DAO {
   ...
   * @var string
   */
  public static $_tableName = 'civicrm_resoure_calendar';
  ...
  /**
   * Null or Resource template id's
   *
   * @var varchar(64)
   */
  ...
  public function __construct() {
    $this->__table = 'civicrm_resoure_calendar';
    parent::__construct();
  }
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('Resoure Calendars') : E::ts('Resoure Calendar');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'required' => TRUE,
          'where' => 'civicrm_resoure_calendar.id',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
          'readonly' => TRUE,
          'add' => '1.0',
        ],
        'calendar_title' => [
          ...
          'where' => 'civicrm_resoure_calendar.calendar_title',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'calendar_type' => [
          ...
          'where' => 'civicrm_resoure_calendar.calendar_type',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'show_past_events' => [
          ...
          'description' => E::ts('Show Past Resources'),
          'where' => 'civicrm_resoure_calendar.show_past_events',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'show_end_date' => [
          ...
          'where' => 'civicrm_resoure_calendar.show_end_date',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'show_public_events' => [
          ...
          'where' => 'civicrm_resoure_calendar.show_public_events',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'events_by_month' => [
          ...
          'where' => 'civicrm_resoure_calendar.events_by_month',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'event_timings' => [
          ...
          'where' => 'civicrm_resoure_calendar.event_timings',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'events_from_month' => [
          ...
          'where' => 'civicrm_resoure_calendar.events_from_month',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'event_type_filters' => [
          ...
          'where' => 'civicrm_resoure_calendar.event_type_filters',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'week_begins_from_day' => [
          ...
          'where' => 'civicrm_resoure_calendar.week_begins_from_day',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'time_format_24_hour' => [
          ...
          'where' => 'civicrm_resoure_calendar.time_format_24_hour',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'recurring_event' => [
          ...
          'where' => 'civicrm_resoure_calendar.recurring_event',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'enrollment_status' => [
          ...
          'where' => 'civicrm_resoure_calendar.enrollment_status',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
        ...
        'event_templates' => [
          ...
          'description' => E::ts('Null or Resource template id\'s'),
          'where' => 'civicrm_resoure_calendar.event_templates',
          'table_name' => 'civicrm_resoure_calendar',
          'entity' => 'ResoureCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResoureCalendar',
          'localizable' => 0,
  ...
  public static function &import($prefix = FALSE) {
    $r = CRM_Core_DAO_AllCoreTables::getImports(__CLASS__, 'resoure_calendar', $prefix, []);
    return $r;
  }
  ...
  public static function &export($prefix = FALSE) {
    $r = CRM_Core_DAO_AllCoreTables::getExports(__CLASS__, 'resoure_calendar', $prefix, []);
    return $r;
  }
