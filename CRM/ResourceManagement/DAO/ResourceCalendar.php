 ...
 * (GenCodeChecksum:a84632bfbada0bd8755dd56e54c88ed4)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'show_past_events' => [
          ...
          'where' => 'civicrm_resource_calendar.show_past_events',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'show_end_date' => [
          ...
          'where' => 'civicrm_resource_calendar.show_end_date',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'show_public_events' => [
          ...
          'where' => 'civicrm_resource_calendar.show_public_events',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'events_by_month' => [
          ...
          'where' => 'civicrm_resource_calendar.events_by_month',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'event_timings' => [
          ...
          'where' => 'civicrm_resource_calendar.event_timings',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'events_from_month' => [
          ...
          'where' => 'civicrm_resource_calendar.events_from_month',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'event_type_filters' => [
          ...
          'where' => 'civicrm_resource_calendar.event_type_filters',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'week_begins_from_day' => [
          ...
          'where' => 'civicrm_resource_calendar.week_begins_from_day',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'time_format_24_hour' => [
          ...
          'where' => 'civicrm_resource_calendar.time_format_24_hour',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'recurring_event' => [
          ...
          'where' => 'civicrm_resource_calendar.recurring_event',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'enrollment_status' => [
          ...
          'where' => 'civicrm_resource_calendar.enrollment_status',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
        ...
        'event_templates' => [
          ...
          'where' => 'civicrm_resource_calendar.event_templates',
          'table_name' => 'civicrm_resource_calendar',
          'entity' => 'ResourceCalendar',
          'bao' => 'CRM_ResourceManagement_DAO_ResourceCalendar',
          'localizable' => 0,
